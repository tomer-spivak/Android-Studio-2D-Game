...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    private void showNotification(Context context, String title, String message) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, channelId).setSmallIcon(R.drawable.logo).setContentTitle(title)
                .setContentText(message).setAutoCancel(true).setPriority(NotificationCompat.PRIORITY_MAX);
